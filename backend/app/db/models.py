...
class KnowledgeItem(Base, TimestampMixin):
    ...
    methods: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list, server_default="[]")
    contributions: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list, server_default="[]")
    reusable_points: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list, server_default="[]")
...
class Experiment(Base, TimestampMixin):
    ...
    code_files: Mapped[dict[str, str]] = mapped_column(JSONB, nullable=False, default=dict, server_default="{}")
    dependencies: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list, server_default="[]")
    run_command: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list, server_default="[]")
    codegen_model: Mapped[str | None] = mapped_column(String(160))
    code_generated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
